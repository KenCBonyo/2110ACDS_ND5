"""
    ...
    Description: This file contains code used to formulate a POST requests
...
# Load data from file to send as an API POST requests.
...
url = 'http://192.168.1.104:5000/api_v0.1'

# Perform the POST requests.
print(f"Sending POST requests to web server API at: {url}")
print("")
print(f"Querying API with the following data: \n {test.iloc[1].to_list()}")
print("")
# feature_vector_dict = json.loads(feature_vector_json)
